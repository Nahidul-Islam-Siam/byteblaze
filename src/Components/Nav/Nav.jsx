...
const Nav = () => {
    ...
    return (
        ...
        <div className="flex-1">
          <Link to='/' className="btn btn-ghost normal-case text-2xl gap-0 text-secondary">Sam<span className="text-primary">Blize</span></Link>
        </div>
        <div className="flex-none gap-2">
          <ul className="menu menu-horizontal px-1 hidden sm:flex gap-5 items-center">
            ...
            <NavLink to='/blogs' className={({isActive})=>isActive? 'text-primary': 'font-bold'}>
              Blogs
            </NavLink>
            <NavLink to='/bookmarks' className={({isActive})=>isActive? 'text-primary': 'font-bold'}>
              Bookmarks
            </NavLink>
          </ul>
