...
const BlogCard = ({blog,deletable,handleDelete}) => {
    ...
    className='absolute bg-primary hover:bg-secondary p-3 rounded-full ml-5 
    cursor-pointer group hover:scale-105 -top-5 -right-5'><MdDeleteForever size={20} className='text-secondary group-hover:text-primary ' /></div>}
